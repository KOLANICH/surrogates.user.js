...
* [habr.com](./habr.com.surrogate.user.js) - only expansion of spoilers (with `details/summary`) has been implemented.
* [4PDA](./4pda_spoilers.surrogate.user.js) - Replaces spoilers with `details/summary`
